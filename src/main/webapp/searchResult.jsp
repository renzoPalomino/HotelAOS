                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row container ">
                            ...
                            <div class="col-lg-5 ">
                                <h4 class="h4">Detalles</h4>
                                <p><%=x.getDescripcion()%></p>
                                <p class='input-group date' >
                                    <b>Fecha de inicio: </b><input id='datetimepicker1' type='date' class="form-control" value="" min="" required/>
                                </p>
                                <p class='input-group date' >
                                    <b>Fecha de fin: </b><input id='datetimepicker2' type='date' class="form-control" value="" min="" required/>
                                </p>
                                
                                <%if(x.getNumHab()!=0){%>
                                <p><b>Número de habitacion: </b><%=x.getNumHab()%></p><%}%>
                                ...
                                <%}%>
                                -->
                                <p><b>Piso: </b><%=x.getTipo()%></p>
                                <p id="precioP-<%=x.getIdInmueble()%>"><b>Precio por noche: </b>S/<%=x.getPrecio()%></p>
