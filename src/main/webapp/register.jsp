...
<html>
    ...
    <div class="row pt-5 align-items-center">
        ...
        <div class="col-md-5 pr-lg-5">
            <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_wd1udlcz.json" background="transparent"  speed="1"  class="img-fluid mb-3 d-md-block" loop autoplay></lottie-player>
        </div>
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
            ...
            <form action="control" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <!-- First Name -->
                    <div class="input-group input-group-lg col-lg-6 mb-4">
                    ...
                    <!-- Email Address -->
                    <div class="input-group input-group-lg col-lg-12 mb-4">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                    ...
                    <div class="form-group col-lg-12 mx-auto mb-0">
                        <button type="submit" class="btn color-primary text-white btn-block btn-lg py-2" >
