...
<%
        ...
        %>
<!--navBar-->
        <nav class="navbar navbar-expand-md bg-navbarR navbar-dark py-3 fixed-top shadow-sm">
            <%if (nivel==0){%>
            <a class="navbar-brand" href="adminpage.jsp">Hotel Pando</a>
            <%}else{%>
            <a class="navbar-brand" href="home.jsp">Hotel Pando</a>
            <%}%>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item px-2">
        <a class="nav-link" href="dashboard.jsp">Habitaciones</a>
      </li>
      <%}%>
      <%if (nivel==1){%>
      <li class="nav-item px-2">
        <a class="nav-link" href="cliInmuebles.jsp">Mis reservas</a>
      </li>
      <%}%>
    </ul>
